                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex flex-column gap-10">
                            ...
                            <div class="fv-row">
                                ...
                                <!--begin:: 2-->
                                <div wire:ignore>
                                    <select class="form-select" data-control="select2" data-placeholder="Select an option" wire:model="customer_id" onchange="@this.set('customer_id', this.value)" name="customer_id" id="customer_id">

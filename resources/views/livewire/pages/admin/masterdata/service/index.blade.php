    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <button class="btn btn-sm fw-bold btn-primary" wire:click="create" data-bs-toggle="modal" data-bs-target="#ServiceModal">Add Service</button>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                            ...
                            <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a wire:click="edit({{ $Service->id }})" class="menu-link px-3 w-100" data-bs-toggle="modal" data-bs-target="#ServiceModal">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">

            ...
            <div class="w-lg-500px p-10">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" action="#">
                    ...
                    <div class="fv-row mb-8">
                        <!--begin::Email-->
                        <input type="text" wire:model.defer="email" placeholder="Email" name="email" autocomplete="off" class="form-control bg-transparent" id="email" />
                    ...
                    <div class="fv-row mb-3">
                        <!--begin::Password-->
                        <input type="password" wire:model.defer="password" placeholder="Password" name="password" autocomplete="off" class="form-control bg-transparent" id="password"/>
                    ...
                    <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                        <div></div>
                        <!--begin::Link-->
                        <s href="../../demo1/dist/authentication/layouts/corporate/reset-password.html" class="link-primary">Forgot Password ?</s>
                        <!--end::Link-->
                    </div>
                    ...
                    <div class="d-grid mb-10">
                        <button type="submit" wire:click.prevent="login" class="btn btn-primary">
                    ...
                    <a class="link-primary">Sign up</a></div>
                    <!--end::Sign up-->
                </form>
                <!--end::Form-->
            </div>
